...
# initialInventoryToTest_Set = [322369,
                              # 186732,
                              # 50920,
                              # 41100,
                              # 34700,
...
for n_itemIter in itemNamesInventory:
  ...
  #for initialInventoryToTest in initialInventoryToTest_Set:
  execfile(codePath + 'DisasterStochLP_v02_m_InnerLoopMakeSubsets_2014_07_22_c.py')

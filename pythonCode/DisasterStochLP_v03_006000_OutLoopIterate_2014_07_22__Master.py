...
for n_itemIter in itemNamesInventory:
    ...
    execfile(codePath + 'DisasterStochLP_v03_007000_InnerLoopMakeSubsets_2014_07_22_c.py')
    execfile(codePath + 'DisasterStochLP_v03_008000_WriteOutFiles_2014_07_22.py') 

...
def f_solveStochLPDisasterGurobiSubLoc3(demand_tmpD
        ...
        #Test 1
        demand_tmpD = {
        ('0000-0000', 'SubLoc_00000'): 1931,
        ('0000-0001', 'SubLoc_00000'): 1180,
        ...
        ('Dallas, Texas', 'DisasterCity2', 'Truck'):50, 
...
#       just printing the results            
        ...
        #(1) T-Metric for non fixed dummy model
        #(2) adjusted duals for depots and carriers for dummy and no-fixed dummy model
...
def dummyhelper(demand_tmpD
        ...
        for depot in carrierDict:
                ...
                for carrier in depotCarriers:
                    for disasterName in disasterList:
                        ...
                        duoVars[depot+":"+carrier[0]+":"+disasterName] = m.addVar(lb=0.0, ub=carrier[1], vtype=GRB.CONTINUOUS, name=depot+":"+carrier[0]+disasterName) 
                ...
                for carrier in depotCarriers:
                        for disaster in disasterList:
                                if (depot, demandAddress_tmpD[disaster], 'Truck') in costD:
                                        ...
                                        if depot+":"+carrier[0]+":"+disaster[0] not in duoToTris:
                                            duoToTris[depot+":"+carrier[0]+":"+disaster[0]] = []
                                        duoToTris[depot+":"+carrier[0]+":"+disaster[0]].append(var)
                m.update()
        ...
        for disasterName in disasterList:
            duoVars["dummy:dummycarrier:"+disasterName[0]] = m.addVar(lb=0.0, vtype=GRB.CONTINUOUS, name="dummy:dummycarrier:"+disasterName[0]) 
            duoToTris["dummy:dummycarrier:"+disasterName[0]] = []
        dummyTris = []
        for disasterName in disasterList:
                ...
                duoToTris["dummy:dummycarrier:"+ disasterName[0]].append(var)
        ...
        for disasterTuple in demand_tmpD:
                ...
                for depot in carrierDict:
                        depotCarriers = carrierDict[depot]
                        for carrier in depotCarriers:
                                if depot+":"+carrier[0]+":"+disasterTuple[0]+":"+disasterTuple[1] in triVars:
                                        RHS.addTerms(1,triVars[depot+":"+carrier[0]+":"+disasterTuple[0]+":"+disasterTuple[1]])
        ...
        for disasterTuple in demand_tmpD:
                for depot in carrierDict:
                        ...
                        for carrier in depotCarriers:
                                                LHS = LinExpr()
                                                LHS.addTerms(1, duoVars[depot+":"+carrier[0]+":"+disasterTuple[0]])
                                                RHS = LinExpr()
                                                if depot+":"+carrier[0]+":"+disasterTuple[0] in duoToTris:
                                                    for tri in duoToTris[depot+":"+carrier[0]+":"+disasterTuple[0]]:
        ...
        for disasterTuple in demand_tmpD:
                        for depot in carrierDict:
                                if depot in inventory_tmpD: #Only consider depots we have inventory in
                                        ...
                                        RHS = LinExpr()
                                        for carrier in depotCarriers:
                                                         if depot+":"+carrier[0]+":"+disasterTuple[0] in duoVars:
                                                                         RHS.addTerms(1,duoVars[depot+":"+carrier[0]+":"+disasterTuple[0]])
...
#                        var = m.addVar(lb=0.0, vtype=GRB.CONTINUOUS, name=depot+":"+carrier[0]+":"+disaster[0]+disaster[1]) 
#                        triVars[depot+":"+carrier[0]+":"+disaster[0]+disaster[1]] = var
#                        duoToTris[depot+":"+carrier[0]].append(var)x
#        m.update()
#Old code without considering sublocals-----ends
...
#NOTE ALEX: NOT SURE IF THE FOLLOWING IS CORRECTLY RESOLVED
        for disasterTuple in demand_tmpD:
        ...
        m.update()
        m.optimize()
        m.write("jamesmodelnonfixeddummy.lp")
